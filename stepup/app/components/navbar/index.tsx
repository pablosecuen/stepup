    ...
    <nav className=" relative border border-black">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          } md:translate-x-0 transform transition-transform w-full md:w-auto mt-16 md:mt-0  absolute top-0 left-0 md:relative md:top-auto md:left-auto bg-white md:bg-transparent  md:p-0 md:space-x-8 md:flex md:flex-row md:border-0  md:items-center`}
        >
